...
//         setIsLoading(true)
//         try {
//             // Убедитесь, что этот эндпоинт существует в вашем API
//             const response = await fetch('/api/login', {
//                 method: 'POST',
//                 headers: { 'Content-Type': 'application/json' },
//                 // Изменено: отправляем login вместо email
...
//                         Используйте Telegram или логин для доступа к призам.
//                     </p>
            ...
            <div className="bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl text-center transform transition-all scale-100 relative">
                ...
                <div className="mb-6">
                    ...
                    <div className="mt-4 text-xs text-gray-400">
                        ...
                        Юзер: <b>test@user.com</b> / <b>password</b>
                    </div>
                </div>
            </div>
        </div>
